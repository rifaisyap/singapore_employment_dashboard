...
with right:
    with st.container(border=True):
        tab1, tab2, tab3, tab4 = st.tabs([ # salary
            "Executive Summary",
...
with tab3:
    ...
    sal_filtered = filtered_data[filtered_data["Occupation"] != "All Occupations"]
    ...
    st.plotly_chart(fig_bar, use_container_width=True, cliponaxis=False)
